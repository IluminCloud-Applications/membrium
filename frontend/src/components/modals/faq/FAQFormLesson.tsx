...
import type { FAQCourse, FAQModule, FAQLesson } from "@/types/faq";

interface FAQFormLessonProps {
    courseId: string;
    moduleId: string;
    lessonId: string;
    courses: FAQCourse[];
...
/**
 * Cascade selector: Curso → Módulo → Aula
 * Shows a success state when a lesson is selected.
 */
export function FAQFormLesson({
    courseId,
    moduleId,
    lessonId,
    courses,
